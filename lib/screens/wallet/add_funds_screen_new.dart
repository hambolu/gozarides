  ...
  void _handleBankTransfer() async {
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Transaction recorded. Your wallet will be credited once the transfer is confirmed'),
          ),
        );
        Navigator.pop(context);
      }
              ...
              Expanded(
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: ShapeDecoration(
                      color: _selectedPaymentMethod == PaymentMethod.card ? Colors.white : Colors.transparent,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(6),
                      ),
                      shadows: _selectedPaymentMethod == PaymentMethod.card
                          ? [
                              const BoxShadow(
                    ...
                    child: Text(
                      'Debit Card',
                      style: TextStyle(
                        color: _selectedPaymentMethod == PaymentMethod.card ? const Color(0xFF212121) : const Color(0xFF757575),
                        fontSize: 14,
                        fontFamily: 'Poppins',
                        fontWeight: FontWeight.w500,
                      ),
              ...
              Expanded(
                child: GestureDetector(
                  ...
                  child: Container(
                    height: double.infinity,
                    decoration: ShapeDecoration(
                      color: _selectedPaymentMethod == PaymentMethod.bank_transfer ? Colors.white : Colors.transparent,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(6),
                      ),
                      shadows: _selectedPaymentMethod == PaymentMethod.bank_transfer
                          ? [
                              const BoxShadow(
                                color: Color(0x0C000000),
                                blurRadius: 8,
                    ...
                    child: Text(
                      'Bank Transfer',
                      style: TextStyle(
                        color: _selectedPaymentMethod == PaymentMethod.bank_transfer ? const Color(0xFF212121) : const Color(0xFF757575),
                        fontSize: 14,
                        fontFamily: 'Poppins',
                        fontWeight: FontWeight.w500,
                      ),
                  ...
                  Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('Amount pasted from clipboard')),
                          );
                        },
                        child: const Icon(
                          Icons.paste_rounded,
